...
export const NAV_SECTIONS = [
  ...
  },
  {
    ...
    icon: 'pi pi-ticket',
    to: { name: 'campaigns-coupons' },
    routeNames: ['campaigns-coupons'],
    group: 'campaigns',
    nested: true,
  },
  {
    id: 'campaignsPromotions',
    labelKey: 'nav.promotions',
    icon: 'pi pi-percentage',
    to: { name: 'campaigns-promotions' },
    routeNames: ['campaigns-promotions'],
    group: 'campaigns',
    nested: true,
  },
  {
    id: 'campaignsLoyalty',
    labelKey: 'nav.loyaltyPoints',
    icon: 'pi pi-star',
    to: { name: 'campaigns-loyalty' },
    routeNames: ['campaigns-loyalty'],
    group: 'campaigns',
    nested: true,
  },
